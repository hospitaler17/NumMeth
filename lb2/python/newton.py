...
# x2 = 1 # проверочное значение для x2
e1 = 0.000000001
...
while (True):
	...
	F[0] = math.sin(x1) - x2 - 1.32 # мои данные (вариант № 4)
	...
	# F[0] = math.sin(x1+1) - x2 - 1; # проверочные данные (вариант № 10)
	# F[1] = 2 * x1 + math.cos(x2) - 2;
	# J[0][0] = math.cos(x1+1);
	# J[0][1] = -1;
	# J[1][0] = 2;
	# J[1][1] = (-1) * math.sin(x2);
